...
public class Robot implements Competition {
    ...
    public Robot(String name, double maxRunRange, double maxJumpHeight) {
        this.name = name;
    ...
    public void run(double dist) {
        if (dist <= maxRunRange) {
            ...
            System.out.println("Робот " + name + " провалил тест на бег и пошел отдыхать!");
            isInvolved = false;
        }
    }
    ...
    public void jump(double height) {
        if (height <= maxJumpHeight) {
            ...
            System.out.println("Робот " + name + " провалил тест на прыжок и пошел отдыхать!");
            isInvolved = false;
        }
    }
